...
klay <- mutate(klay, minute = (12*period - minutes_remaining))
draymond <- mutate(draymond, minute = (12*period - minutes_remaining))
kevin <- mutate(kevin, minute = (12*period - minutes_remaining))
andre <- mutate(andre, minute = (12*period - minutes_remaining))
